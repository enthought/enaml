...
building user interfaces. It is a declarative language based on Python, 
analogous to Qt's QML. Enaml currently supports wxWidgets as a backend via 
wxPython, and Qt as a backend via PySide and PyQt4. However, it is not tied 
