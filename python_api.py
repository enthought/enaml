...
def create_view():
    ...
    # Parent-child relationships can also be established the other
    # way around, by specifying children instead of parents.
    main_container.children.extend([
        PushButton(text='Just'),
        PushButton(text='Some'),
        Container(
            hug_height='strong',
            children=[
                Field(text='Extra'),
