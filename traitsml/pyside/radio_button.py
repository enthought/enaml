...
class RadioButtonWidget(GeneralWidgetMixin, QtGui.QRadioButton):
    pass


class RadioButton(Element):
    
    # Whether the button is currently checked - Bool
    ...
    def init_widget(self):
        super(RadioButton, self).init_widget()
        widget = self.widget
    ...
    def init_attributes(self):
        super(RadioButton, self).init_attributes()
        self.init_checked()
        self.init_text()
