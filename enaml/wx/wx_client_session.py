...
class WxClientSession(object):
    ...
    def __init__(self, session_id, username, router, factories):
        ...
        factories : dict
            The Wx factory functions to use when building the view.
    ...
    def send_action(self, widget_id, action, content):
        ...
        This method is normally only called by the WxMessengerWidget's
        which are owned by this WxClientSession object. This should not 
    ...
    def widget_destroyed(self, widget_id):
        ...
        This method is called directly by a WxMessengerWidget when
