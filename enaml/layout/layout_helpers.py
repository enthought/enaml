    ...
    def __init__(self, *items, **metadata):
        ...
        **metadata
            ...
            orientation
                ...
                which indicates the abutment orientation. The default
                is 'vertical'.
    ...
    def __init__(self, *items, **metadata):
        ...
        **metadata
            ...
            anchor
                ...
                'bottom', 'v_center', or 'h_center'. The default is
                'v_center'.
...
class LinearBoxHelper(DeferredConstraints):
    ...
    def __init__(self, *items, **metadata):
        ...
        **metadata
        ...
        self.constraints_id = uuid4().hex

        for attr in ('top', 'bottom', 'left', 'right'):
            name = self.orientation[0] + 'box-' + attr
            var = ConstraintVariable(name, self.constraints_id)
    ...
    def _get_constraints(self, component):
        ...
        first_boundary = get(self, first)
        last_boundary = get(self, last)
        first_ortho, last_ortho = self.orientation_map[self.ortho_orientation]
        first_ortho_boundary = get(self, first_ortho)
        last_ortho_boundary = get(self, last_ortho)
