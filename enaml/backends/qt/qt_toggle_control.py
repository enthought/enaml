...
class QtToggleControl(QtControl, AbstractTkToggleControl):
    ...
    This class can serve as a base class for widgets that implement toggle
    behavior such as CheckBox, RadioButton and checkable PushButtons. It is not
    meant to be used directly. Subclasses should implement the 'create' and
    bind methods.
