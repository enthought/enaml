...
class Color(HasStrictTraits):
    ...
    def from_string(cls, color_string):
        ...
        if match:
            ...
            res = cls.color_map.get(color_string, cls.no_color).copy()
        return res
    ...
    def __repr__(self):
        templ = 'Color(r=%s, g=%s, b=%s, a=%s)'
        return templ % (self.r, self.g, self.b, self.a)
...
no_color = Color()
no_color.add_trait('r', Constant(-1))
no_color.add_trait('g', Constant(-1))
no_color.add_trait('b', Constant(-1))
no_color.add_trait('a', Constant(-1))
...
# All 147 CSS colors plus a few of our own ("error", "nocolor", "readonly")
Color.color_map = {
