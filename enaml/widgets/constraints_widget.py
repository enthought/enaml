...
class ConstraintsWidget(WidgetComponent):
    ...
    def initial_attrs(self):
        ...
        A ConstraintsWidget adds the following keys to the initial
        attributes dict.

        'constraints_id'
            The unique string identifier for tracking ownership of the
            constraints generated by this widget.

        'layout'
            A dictionary of layout information. This dict contains the
            following keys:
